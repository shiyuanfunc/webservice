 ...
 * 
 */
@WebServiceClient(name = "MobileCodeWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/K:/Eclispe/webservicetest/src/MobileCodeWS.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/K:/Eclispe/webservicetest/src/MobileCodeWS.wsdl");
